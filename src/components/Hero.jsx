    ...
    <div className='flex w-full justify-center mt-5 h-screen mx-auto'>
      <div className='text-center'>
        ...
        <div className='flex-col lg:flex-row justify-between mt-3 mx-auto'>
          <button className='border border-black text-white bg-black px-5 py-3 min-w-[220px] lg:mr-2 mt-5 rounded'>
            Need a Web developer
          </button>
          <button className='border border-black bg-white text-black px-5 py-3 min-w-[220px] lg:ml-2 mt-5 rounded'>
            Need a Web designer
          </button>
        </div>
